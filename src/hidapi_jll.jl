...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import hidapi_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("fc16ec7e-3cba-5ca4-a17a-1acd8165bbee"))
platforms = [Pkg.Artifacts.unpack_platform(e, "hidapi", artifacts_toml) for e in artifacts["hidapi"]]
...
if best_platform === nothing
    @debug("Unable to load hidapi; unsupported platform $(triplet(platform_key_abi()))")
else
